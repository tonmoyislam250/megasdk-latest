...
//line /usr/local/go/src/megasdkgo/megasdkgo.go:1:1
package megasdkgo
...
func (m *MegaClient) Login(email string, password string) error {
	...
	defer func() {
		func() { _cgo0 := /*line :42:10*/unsafe.Pointer(ret); _cgoCheckPointer(_cgo0, nil); /*line :42:30*/_Cfunc_free(_cgo0); }()
	}()
	if ret.errorCode != 0 {
...
func (m *MegaClient) AddDownload(link string, dir string) (string, error) {
	...
	defer func() {
		func() { _cgo0 := /*line :53:10*/unsafe.Pointer(ret); _cgoCheckPointer(_cgo0, nil); /*line :53:30*/_Cfunc_free(_cgo0); }()
	}()
...
func (m *MegaClient) GetDownloadInfo(gid string) *DownloadInfo {
	...
	func() { _cgo0 := /*line :76:9*/unsafe.Pointer(status); _cgoCheckPointer(_cgo0, nil); /*line :76:32*/_Cfunc_free(_cgo0); }()
	return di
}
